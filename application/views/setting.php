      ...
      <div class="row">
        <div class="col-md-9">
          ...
          <?php if($this->session->flashdata('ketua')):?>
              <div class="alert alert-success alert-dismissible" role="alert">
                <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                Data Ketua BPKD Kota Padang Panjang <strong>berhasil</strong> <?= $this->session->flashdata('ketua');?>
              </div>
          <?php endif;?>
            ...
            <div class="tab-content">
              ...
              <div class="tab-pane" id="pejabat">
                ...
                <div class="col-md-6 text-center">
                  <img src="<?= base_url();?>assets/dist/img/logo-padangpanjang.png" class="img-responsive img-thumbnail">
                </div>
                </div>
              </div>
              <!-- /.tab-pane -->
