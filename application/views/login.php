...
<head>
	...
	<!-- App favicon -->
    <link rel="shortcut icon" href="<?= base_url();?>assets/dist/img/logo-padangpanjang.png" type="image/x-icon">
	<meta charset="UTF-8">
	<meta name="viewport" content="width=device-width, initial-scale=1">
<!--===============================================================================================-->	
	<link rel="icon" type="image/png" href="<?= base_url();?>assets/dist/img/logo-padangpanjang.png"/>
<!--===============================================================================================-->
			...
			<div class="wrap-login100">
				<div class="login100-form-title" style="background-image: url(<?= base_url();?>assets/admin/images/bg-01.png);">
					<span class="login100-form-title-1">
						<img src="<?= base_url();?>assets/dist/img/logo-padangpanjang.png" alt="" style="width: 120PX;">
					</span>
				</div>
