...
<head>
  ...
  <title>BPKD Kota Padang Panjang</title>

  <!-- Favicon -->
  <link rel="shortcut icon" type="image/x-icon" href="<?= base_url();?>assets/dist/img/logo-padangpanjang.png">
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="#" class="logo">
      ...
      <span class="logo-mini"><img src="<?= base_url();?>assets/dist/img/logo-padangpanjang.png" style="width: 60%;"></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><img src="<?= base_url();?>assets/dist/img/logo-padangpanjang.png" style="width: 30px;"> | BPKD Kota Padang Panjang</span>
    </a>
